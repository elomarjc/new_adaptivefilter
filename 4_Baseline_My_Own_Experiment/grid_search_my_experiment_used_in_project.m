...
[u, fs] = audioread("C:\Users\eloma\Desktop\new_adaptivefilter\4_Baseline_My_Own_Experiment\NHS data\ambient noise (clean)\Primary.wav");  % Primary - Noisy signal with heartbeat   
[d, ~] = audioread("C:\Users\eloma\Desktop\new_adaptivefilter\4_Baseline_My_Own_Experiment\NHS data\ambient noise (clean)\Secondary.wav"); % Reference noise signal     
[x, ~] = audioread("C:\Users\eloma\Desktop\new_adaptivefilter\4_Baseline_My_Own_Experiment\NHS data\ambient noise (clean)\Clean.wav"); % Clean noise signal     

%x = u - d;

% Name of audio type to have in figures and folder name
suffix = 'My Own Heart Ambient';
...
N_plot = 15000; % Plotting only a portion
