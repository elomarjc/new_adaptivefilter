...
% 
% tightfig();
% saveas(gcf,  fullfile(foldername, 'Convergence rate (raw) - NHS1.pdf'));
% 
...
% 
% tightfig();
% saveas(gcf,  fullfile(foldername, 'Convergence rate (smooth) - NHS1.pdf'));
...
% Save figure
tightfig();
saveas(gcf, fullfile(foldername, 'Output SNR vs Filter Order - NHS1.pdf'));
...
% Save the figure
tightfig();
saveas(gcf, fullfile(foldername, 'Mel_Spectrogram - NHS1.pdf'));
...
% Save figure
tightfig();
saveas(gcf, fullfile(foldername, 'Error signals - NHS1.pdf'));
...
[~, ~, w_hist_LMS] = lms_filter(noise, primary, bestFilterOrder_LMS, bestMu_LMS);
[~, ~, w_hist_NLMS] = nlms_filter(noise, primary, bestFilterOrder_NLMS, bestMu_NLMS);
[~, ~, w_hist_RLS] = rls_filter(noise, primary, bestFilterOrder_RLS, bestLambda_RLS);
...
% Save figure
tightfig();
saveas(gcf, fullfile(foldername, 'Frequency Response of Final Weights - NHS1.pdf'));
