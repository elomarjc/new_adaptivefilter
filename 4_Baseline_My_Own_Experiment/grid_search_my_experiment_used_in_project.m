...
%[x, ~] = audioread("C:\Users\eloma\Desktop\new_adaptivefilter\4_Baseline_My_Own_Experiment\NHS data\ambient noise (clean)\Primary.wav"); % Reference noise signal     

%Estimate clean signal (pseudo-clean), since we dont have that in real-life
x = u - d;
